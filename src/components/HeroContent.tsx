  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <div className="space-y-8 md:space-y-10">
        ...
        <div className="max-w-3xl mx-auto space-y-6 animate-fade-in px-4" style={{ animationDelay: '0.6s' }}>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-12 sm:pl-16 py-5 sm:py-6 text-base sm:text-lg border-0 focus:ring-2 focus:ring-blue-500/20 rounded-2xl bg-transparent text-slate-700 dark:text-slate-200 placeholder:text-slate-400 dark:placeholder:text-slate-500 font-medium"
                  />
                </div>
                <Button
                  onClick={handleSearch}
                  size="lg"
                  className="py-5 sm:py-6 px-6 sm:px-8 rounded-2xl font-semibold bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white transition-all duration-300 hover:scale-105 hover:shadow-2xl group border-0 text-base sm:text-lg"
                >
